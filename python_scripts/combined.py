...
if __name__ == "__main__":
    ...
    output_dir = "./output_combined_plant_horizontal/"
    ...
    for i in range(len(filenames) - 1):
        ...
        edges2 = cv2.Canny(grey2, 50, 150)

        # Compute optical flow
        optical_flow = cv2.calcOpticalFlowFarneback(edges1, edges2, None, 0.6, 4, 10, 5, 7, 1.2, 0)
